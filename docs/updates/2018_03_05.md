...
Our plan is to dedicate 12 full weeks to Xray and see how far we can get with the implementation. We originally planned to start this trial period 2 weeks ago, but decided to defer it in order to spend more time doing planning around our vision real time collaboration. So last week will count as week 1 of 12. This week is week 2 of 12.
